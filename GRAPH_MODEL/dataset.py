...
class SROIEDataset(Dataset):
    ...
    def _prepare(self, data_dir):
        ...
        for ann in annotation_list:
            ...
            edge_data = torch.from_numpy(edge_data).float().to(device)
...
if __name__ == '__main__':
    ...
    alphabet = ' !"#$%&()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`{|}~ÀÁÂÃÈÉÊÌÍÒÓÔÕÙÚÝĂĐĨŨƠƯẠẢẤẦẨẪẬẮẰẲẴẶẸẺẼẾỀỂỄỆỈỊỌỎỐỒỔỖỘỚỜỞỠỢỤỦỨỪỬỮỰỲỴỶỸ'
